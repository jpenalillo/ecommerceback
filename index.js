...
const { verificarCredenciales, registrarUsuario, generarPerfiles, obtenerUsuarios, updateUsuarios, registrarProductos, registrarCategorias, obtenerProductos, obtenerProductosId, comprar, obtenerCompras } = require('./middleware')
